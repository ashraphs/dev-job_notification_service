...
@EnableJpaRepositories(basePackages = {"com.tng.abt.jobnotificationservice.repositories"},
...
public class AppConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        em.setPackagesToScan(new String[]{"com.tng.abt.jobnotificationservice.entities"});
    ...
    @Bean("abtDataSource")
    @ConfigurationProperties(prefix = "abt.datasource")
    public DataSource abtDataSource() {
